...
public class ChatSessionManager {
     ...
     */
    public void addSession(Session session, Long memberId, Long hotelId) {
        String key = generateKey(memberId, hotelId);
     ...
     */
    public Set<Session> getSessions(Long memberId, Long hotelId) {
        String key = generateKey(memberId, hotelId);
    ...
    private String generateKey(Long memberId, Long hotelId) {
        return memberId + "_" + hotelId;
    }
}
